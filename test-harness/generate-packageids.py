'''
Script to generate test data for logistics demo.
Row key format:
#SUPPLIER_RANGE   #TIME_RANGE         #SUFFIX_RANGE
#[1000-1004]  #[YYYYMMDDHHmmSS]   #[4 char suffix hash]        
